...
class ProteinToCellularComponentEdgeLabel(Enum):
    ...
    @classmethod
    def get_all_edge_types(cls):
        return [cls.LOCATED_IN, cls.IS_ACTIVE_IN, cls.PART_OF]
...
class ProteinToMolecularFunctionEdgeLabel(Enum):
    ...
    @classmethod
    def get_all_edge_types(cls):
        return [cls.ENABLES, cls.CONTRIBUTES_TO]
...
class MolecularFunctionToMolecularFunctionEdgeLabel(Enum):
    ...
    @classmethod
    def get_all_edge_types(cls):
        return [cls.IS_A, cls.POSITIVELY_REGULATES, cls.NEGATIVELY_REGULATES,
               cls.PART_OF]
...
class BiologicalProcessToMolecularFunctionEdgeLabel(Enum):
    ...
    @classmethod
    def get_all_edge_types(cls):
        return [cls.POSITIVELY_REGULATES, cls.NEGATIVELY_REGULATES]
