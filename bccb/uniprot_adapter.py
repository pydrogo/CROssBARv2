...
class Uniprot:
    ...
    def __init__(self, organism="*", rev=True, fields: Optional[list] = None):
        ...
        if fields:
            ...
            self.attributes = [field.value for field in fields]
        ...
        # always include "organism-id" and "database(GeneID)" for edges
        # otherwise need to add conditional logic to the edge creation
        # TODO why does "genes" need to be included?
        self.attributes.extend(["organism-id", "database(GeneID)", "genes"])
            ...
            for k in _props.keys():
                ...
                if k in self.protein_properties:
                    ...
                    if k in ["length", "mass", "organism-id"]:
                        ...
                        if k == "organism-id":
                            organism_id = normalize_curie("ncbitaxon:" + _props[k])
    ...
    def get_uniprot_edges(self):
        ...
        for protein in tqdm(self.uniprot_ids):
            ...
            if "database(GeneID)" in self.attributes:
            ...
            if "organism-id" in self.attributes:
