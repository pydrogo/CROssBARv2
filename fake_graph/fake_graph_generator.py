...
def node_creator():
   ...
   """
    ...
    gene_name_and_protein_acc_df = pd.read_csv(r"datasets/gene_name_and_protein_acc.csv")
    ...
    efo_diseases_df = pd.read_csv(r"datasets/efo_disease_terms.csv")
    ...
    kegg_pathway_and_disease_df = pd.read_csv(r"datasets/kegg_pathway_and_disease.csv")
    ...
    reactome_pathway_df = pd.read_csv(r"datasets/reactome_pathway.csv")
    ...
    # drug ids and names
    drug_df = pd.read_csv(r"datasets/drug_terms.csv")
    ...
    # compound ids
    compound_df = pd.read_csv(r"datasets/compound_terms.csv")
    ...
    phenotype_df = pd.read_csv(r"datasets/phenotype_terms.csv")
    ...
    go_function_df = pd.read_csv(r"datasets/go_function_terms.csv")
    ...
    tissue_terms_df = pd.read_csv(r"datasets/tissue_terms.csv").reset_index()
    ...
    frames = []
    for n in range(5):
        patient_df = pd.read_csv(fr"datasets/patient_terms/repository-cases-table.2022-07-09 ({n}).tsv", sep="\t")
    ...
    domain_df = pd.read_csv(r"datasets/domain_terms.tsv", sep="\t")
    ...
    side_effect_df = pd.read_excel(r"datasets/Drug_ADR.xlsx")
    ...
    location_df = pd.read_csv(r"datasets/location_terms.tsv", sep="\t")
